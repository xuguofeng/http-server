package org.net5ijy.nio.http.ant;
...
public class AntPathMatcher implements PathMatcher {
	...
	protected String[] tokenizePath(String path) {
		return tokenizeToStringArray(path, this.pathSeparator, this.trimTokens,
				true);
	}
	...
	private boolean matchStrings(String pattern, String str,
			Map<String, String> uriTemplateVariables) {
		return getStringMatcher(pattern)
				.matchStrings(str, uriTemplateVariables);
	}
	...
	public String combine(String pattern1, String pattern2) {
		...
		// /hotels/* + booking -> /hotels/booking
		if (pattern1.endsWith(this.pathSeparatorPatternCache
				.getEndsOnWildCard())) {
		...
		String file2 = (dotPos2 == -1 ? pattern2 : pattern2.substring(0,
				dotPos2));
		String ext2 = (dotPos2 == -1 ? "" : pattern2.substring(dotPos2));
		boolean ext1All = (ext1.equals(".*") || ext1.equals(""));
		boolean ext2All = (ext2.equals(".*") || ext2.equals(""));
		if (!ext1All && !ext2All) {
			throw new IllegalArgumentException("Cannot combine patterns: "
	...
	protected static class AntPathStringMatcher {
		...
		public AntPathStringMatcher(String pattern, boolean caseSensitive) {
			...
			this.pattern = (caseSensitive ? Pattern.compile(patternBuilder
					.toString()) : Pattern.compile(patternBuilder.toString(),
	...
	protected static class AntPatternComparator implements Comparator<String> {
		...
		private static class PatternInfo {
			...
			public int getTotalCount() {
				return this.uriVars + this.singleWildcards
						+ (2 * this.doubleWildcards);
			}
